...
def test_imports():
    from rl2025.exercise4 import DDPG
    from rl2025.exercise4.train_ddpg import RACETRACK_CONFIG as CONFIG

def test_config():
    from rl2025.exercise4.train_ddpg import RACETRACK_CONFIG
...
def test_restore_file():
    ...
    save_dir = os.path.join(save_dir, 'rl2025/exercise4')
